...
def get_ai_response(user_input):
    ...
    completion = openai.chat.completions.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "system", "content": "You are a helpful assistant for writing a SQL Query of given dataset and by default table name is 'dataset'. and each query will end with a semicolon"},
...
# Result Textbox
result_text = Text(root, height=20, width=150)
